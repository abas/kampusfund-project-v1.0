...
<head>
  ...
  <link href="assets/libs/hover-min.css" rel="stylesheet">
  <link href="assets/libs/lightbox.min.css" rel="stylesheet">
      ...
      <div class="container">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <div class="logo">
              <a href="home-2.html" class="navbar-logo"><img src="assets/images/logo/kampusfundlogo.png" >
              </a>
            </div>
                ...
                <div class="dropdown-menu mega-dropdown-menu">
                  <div class="widget-features">
                    <ul class="menu-alert-message">
                      ...
                      <li class="showalls">
                        <a href="page-alerts.html">Show all messages <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                      </li>
