...
<main>
    ...
    <div class="panel with-nav-tabs panel-default panel-noborder widget-tab-popular">
      <div class="panel-heading">
        <ul class="nav nav-tabs">
          ...
          <li><a href="#tab2default" data-toggle="tab"> Repayment</a></li>
          <li><a href="#tab3default" data-toggle="tab"> Update</a></li>
          <li><a href="#tab4default" data-toggle="tab"> Investor</a></li>
          <li><a href="#tab5default" data-toggle="tab"> Comments</a></li>
        </ul>
      </div>
                    ...
                    <div class="info">
                      <div class="description">
                        ...
                        <ul>
                          ...
                          <li><span style="font-family: 'trebuchet ms', geneva; font-size: medium;">Ingatkan mereka untuk menggunakan&nbsp; Campus Station !</span></li>
                        </ul>
              ...
              <li>
                <div class="media">
                  <div class="media-body">
                    <div class="info">
                      <div class="description">
                        <p>Untuk dapat memahami proses pengembalian dana bisa dihitung melalui kalkulator yang kami sediakan <a href="">disini</a></p>
                        <table class="table table-hover">
                          <thead>
                            <tr>
                              <th scope="col">Dana Usaha</th>
                              <th scope="col">Cicilan Minimum<sub>/per bulan</sub></th>
                              <th scope="col">Bagi Hasil<sub>min.</sub></th>
                              <th scope="col">Lama<sub>min.</sub></th>
                            </tr>
                          </thead>
                          <tbody>
  ...
  <?php
  require 'pages/right-nav-campaign.php'
  ?>
</div>
