      ...
      <form>
        <fieldset>
          ...
          <div class="form-group">
            ...
            <input type="file" class="form-control-file" id="exampleInputFile" aria-describedby="fileHelp">
            <small id="fileHelp" class="form-text text-muted">Surat Pernyataan Kesanggupan didapat
              <a href="#" style="color:#007e6c">disini</a>
            </small>
          </div>
          <fieldset class="form-group">
            <div class="form-check">
              <label class="form-check-label">
                <input class="form-check-input" type="checkbox" value="" checked=""> Saya bersedia mengikuti aturan yang ditetapkan oleh Kampus Fund
                <a href="#" style="color:#007e6c">(Term of Service)</a>
              </label>
            </div>
