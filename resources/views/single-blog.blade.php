...
<div class="detail-header detail-header-blogs-detail-full">
  ...
  <div class="background" style="background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.5)), url({{asset('images/blogs/blog1.jpg')}});"></div>
</div>
</header>
<main>
  <div class="container">
    <div class="middle-text" >
      <div class="detail-topinfo col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="detail-info">
          <span class="date">Oleh <a href="">Husein Indra Kusuma</a><br> January 1, 2017.</span><br>
          <span class="category">
      ...
      <article class="col-lg-12 col-md-12 col-sm-12 col-xs-12 blogs-content blogs-content-detail">
        ...
        <div class="related-blogs">
          ...
          <div class="posts row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 item related-box">
              <div class="photo">
                <a href=""><img src="{{asset('images/blogs/blog2.jpg')}}"></a>
              </div>
