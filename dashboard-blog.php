                          ...
                          <table class="table ">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <button type="button" class="btn btn-secondary" title="Accept Post"><i class="fa fa-check"></i></button>
                                  <button type="button" class="btn btn-secondary" title="Refuse Post"><i class="fa fa-user-times"></i></button>
                                  <button type="button" class="btn btn-secondary" title="Delete Post"><i class="fa fa-times"></i></button>
                                </td>
                              </tr>
                            </tbody>
                          </table>
